...
A project designed to compare the use of unordered_maps and vectors. Uses a list of over 60,000 English words to check a text file for spelling errors.

Usage: 

g++ (mainVec.cpp/mainMap.cpp)

./a.out (word list: usa.txt) (text file: gears.txt)
